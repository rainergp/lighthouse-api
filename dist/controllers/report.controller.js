...
var ReportController = /** @class */ (function () {
    ...
    ReportController.postReport = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                // ],
                // };
                ReportController.runLighthouseAudit()
                    .then(function (data) {
                    res.setHeader('Content-Type', 'application/json');
                    res.send(JSON.stringify({ data: data }));
                })
    ...
    ReportController.runLighthouseAudit = function () {
        return new Promise(function (resolve, reject) {
            LighthouseLogger.setLevel(ReportController.flags.logLevel);
            ReportController.launchHeadlessChromeAndRunLighthouse(ReportController.url, ReportController.flags)
